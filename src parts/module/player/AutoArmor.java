...
import client.utilites.ArmorUtils;
...
public class AutoArmor extends Module {
    ...
    public void onEnable() {
        NotificationPublisher.queue("AutoArmor", "AutoArmor was Enable", NotificationType.INFO);
        super.onEnable();
    }
    @Override
    public void onDisable() {
        NotificationPublisher.queue("AutoArmor", "AutoArmor was Disabled", NotificationType.Disable);
        super.onDisable();
    }
}
